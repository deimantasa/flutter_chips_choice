...
//     )..insert(0, C2Choice<String>(value: 'all', label: 'All', select: (_) {}));
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//                             borderRadius: BorderRadius.all(Radius.circular(20)), side: BorderSide(color: Colors.red)),
//                       ),
//                     ),
//                   ),
//                   Content(
...
//                                 if (data.meta == null) return SizedBox.shrink();
//                                 return CircleAvatar(
...
//                                         style: TextStyle(color: state.hasError ? Colors.redAccent : Colors.green),
//                                       ))
//                                 ],
//                               );
//                             },
...
//                       choiceBuilder: (item) {
//                         return CustomChip(
//                             label: item.label, width: 70, height: 100, selected: item.selected, onSelect: item.select);
//                       },
//                     ),
//                   ),
//                 ],
